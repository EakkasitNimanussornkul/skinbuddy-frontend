...
<template>
  <div class="p-6 overflow-y-auto flex-grow hide-scrollbar">
    <div class="flex items-center gap-2 mb-4">
      <button @click="emit('back')" class="p-1 -ml-1 text-stone-400 hover:text-brand-text rounded-full transition-colors cursor-pointer">
  ...
  <div class="p-4  flex-shrink-0">
    <button @click="executeArchive" :disabled="isSubmitting" class="w-full bg-brand-primary text-white font-bold py-3.5 rounded-xl shadow-lg hover:bg-brand-primary-hover active:scale-[0.98] transition-all text-sm flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer">
