...
<template>
  <Teleport to="body">
    <div v-if="isOpen" class="fixed inset-0 z-50 flex flex-col justify-end sm:justify-center bg-stone-900/80 backdrop-blur-sm p-0 sm:p-4 animate-fade-in" @click.self="emit('close')">
