...
const categoryIcons: Record<string, string> = {
  ...
  Mask: 'M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
}

// Fallback icon path if custom category exists in DB
...
<template>
  <div class="flex overflow-x-auto gap-2.5 pb-2 pt-1 hide-scrollbar snap-x">
    <button
      ...
      :class="[
        'snap-start flex-shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold transition-all border',
        selectedCategory === cat
          ? 'bg-brand-primary text-white border-brand-primary shadow-md shadow-orange-900/15 scale-[1.02]'
          : 'bg-brand-surface-light dark:bg-brand-surface-dark text-stone-600 dark:text-stone-300 border-stone-200 dark:border-stone-800 hover:border-brand-primary/40'
      ]"
    >
      <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" :d="categoryIcons[cat] || fallbackIcon" />
      </svg>
